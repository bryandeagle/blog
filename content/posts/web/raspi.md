...
One of the most fun things to play around with today is a [Raspberry Pi](https://www.raspberrypi.org/). I'm constantly re-imaging my Raspberry Pi ,a nd so this guide walks through steps to take each time to ensure your device is sufficiently secure.
